...
nx = 3 # reinforcement density (number of rebars) in x direction
ny=6 # reinforcement density (number of rebars) in y direction
s_exp = 0.1 # maximal element size
msh_filename = "test_mesh.msh"
xdmf_filenames = ["concrete_mesh.xdmf", "rebar_mesh.xdmf"]

create_concrete_slab(point1, point2, nx, ny, margin, s_exp, msh_filename, xdmf_filenames, z = [0.1,0.98])
